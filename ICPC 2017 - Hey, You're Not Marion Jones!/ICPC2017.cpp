...
main(){
	...
	for(i=0;i<case_num;i++){
		...
		if(num>99999999){
			...
			if(check(ID)){
				if     (ID[0]=='0' || ID[0]=='1')cout << line_string << "/" << ID << " is valid athlete id number" << endl;
				else if(ID[0]=='2' || ID[0]=='3')cout << line_string << "/" << ID << " is valid reserve id number" << endl;
				else if(ID[0]=='4' || ID[0]=='5')cout << line_string << "/" << ID << " is valid judge id number" << endl;
				else if(ID[0]=='6' || ID[0]=='7')cout << line_string << "/" << ID << " is valid staff id number" << endl;
				else if(ID[0]=='8' || ID[0]=='9')cout << line_string << "/" << ID << " is valid press id number" << endl;
			}
			else {
